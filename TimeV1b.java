package TimeClass.version1b;
import TimeClass.version1.TimeV1.*;
public class TimeV1b {
    ...
    public TimeV1b() { // create midnight
        hour=min=sec=0;
    }

    public TimeV1b(int h, int m, int s) {
        this.hour=h;
        this.min=m;
        this.sec=s;
    }

    public TimeV1b(TimeV1b t) {
        this.hour=t.hour;
        this.min=t.min;
        this.sec=t.sec;
    ...
    public int compareTo(TimeV1b t) { //produces the number of seconds from t to this. That is, t.advanceBy(this.compareTo(t)) should set t to the same time as this.
    ...
    public boolean equals(TimeV1b another) { //returns true if and only if the times have the same value.
